...
{{--        </button>--}}
{{--    </nav>--}}
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background: #0b2e13">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" style="width: 40%;" href="#page-top"><img src="{{asset('image/logo.png')}}" alt="" /></a>
