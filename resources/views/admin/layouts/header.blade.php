...
<head>
    ...
    <!-- Title Page-->
    <title>Ashabul Kahfi Admin</title>
    ...
    <link href="{{ asset('admins/vendor/bootstrap-4.1/bootstrap.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('admins/summernote/summernote-bs4.css') }}" rel="stylesheet" media="all">
    <!-- Vendor CSS-->
    ...
    <link href="{{ asset('admins/css/jquery.css') }}" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="{{ asset('admins/css/theme.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css/diagram.css') }}" rel="stylesheet" media="all">
    <style>
        .modal-backdrop{
            position: unset;
        }
